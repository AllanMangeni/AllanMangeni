...
**[x402-recovery](https://github.com/AllanMangeni/x402-recovery)**
- Settlement recovery middleware for x402 payments
- Two-Phase Gap protection with African corridor profiles
- Handles facilitator timeout scenarios before on-chain confirmation
...
|---|---|
| [The Idempotency Problem in African Cross-Border Settlement](https://hackernoon.com/the-idempotency-problem-in-african-cross-border-settlement) | Idempotency failures in cross-border settlement — why African payment corridors expose edge cases that webhook-based rails cannot recover from |
